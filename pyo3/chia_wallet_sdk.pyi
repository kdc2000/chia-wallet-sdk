...
def calculate_vault_puzzle_message(delegatedPuzzleHash: bytes, vaultPuzzleHash: bytes) -> bytes: ...
def calculate_vault_coin_message(delegatedPuzzleHash: bytes, vaultCoinId: bytes, genesisChallenge: bytes) -> bytes: ...
def calculate_vault_start_recovery_message(delegatedPuzzleHash: bytes, leftSideSubtreeHash: bytes, recoveryTimelock: int, vaultCoinId: bytes, genesisChallenge: bytes) -> bytes: ...
...
def bls_member_hash(config: MemberConfig, publicKey: PublicKey, fastForward: bool) -> bytes: ...
def passkey_member_hash(config: MemberConfig, publicKey: R1PublicKey, fastForward: bool) -> bytes: ...
def singleton_member_hash(config: MemberConfig, launcherId: bytes, fastForward: bool) -> bytes: ...
...
def bulletin_puzzle_hash(hiddenPuzzleHash: bytes) -> bytes: ...
...
def select_coins(coins: List[Coin], amount: int) -> List[Coin]: ...
def spend_bundle_cost(coinSpends: List[CoinSpend]) -> int: ...

class Spends:
    def clone(self) -> Spends: ...
    def __init__(self, clvm: Clvm, changePuzzleHash: bytes) -> None: ...
    def add_xch(self, coin: Coin) -> None: ...
    def add_cat(self, cat: Cat) -> None: ...
    def add_nft(self, nft: Nft) -> None: ...
    def p2_puzzle_hashes(self) -> List[bytes]: ...
    def non_settlement_coin_ids(self) -> List[bytes]: ...
    def add_optional_condition(self, condition: Program) -> None: ...
    def add_required_condition(self, condition: Program) -> None: ...
    def disable_settlement_assertions(self) -> None: ...
    def selected_xch_amount(self) -> int: ...
    def selected_asset_ids(self) -> List[bytes]: ...
    def selected_cat_amount(self, assetId: bytes) -> int: ...
    def apply(self, actions: List[Action]) -> Deltas: ...
    def prepare(self, deltas: Deltas, relation: Optional[Relation] = None) -> FinishedSpends: ...
    def with_silent_payment_keys(self, syntheticPks: List[SilentPaymentRegisteredKey], secretKeys: List[SilentPaymentRegisteredSecretKey]) -> None: ...
class FinishedSpends:
    def clone(self) -> FinishedSpends: ...
    def pending_spends(self) -> List[PendingSpend]: ...
    def insert(self, coinId: bytes, spend: Spend) -> None: ...
    def spend(self) -> Outputs: ...
class PendingSpend:
    def clone(self) -> PendingSpend: ...
    def p2_puzzle_hash(self) -> bytes: ...
    def coin(self) -> Coin: ...
    def conditions(self) -> List[Program]: ...
    def as_xch(self) -> Optional[Coin]: ...
    def as_cat(self) -> Optional[Cat]: ...
    def as_did(self) -> Optional[Did]: ...
    def as_nft(self) -> Optional[Nft]: ...
    def as_option(self) -> Optional[OptionContract]: ...
class Action:
    def clone(self) -> Action: ...
    @staticmethod
    def send(id: Id, destination: SendDestination, amount: int, memos: Optional[Program] = None) -> Action: ...
    @staticmethod
    def settle(id: Id, notarizedPayment: NotarizedPayment) -> Action: ...
    @staticmethod
    def issue_cat(tailSpend: Spend, hiddenPuzzleHash: Optional[bytes], amount: int) -> Action: ...
    @staticmethod
    def single_issue_cat(hiddenPuzzleHash: Optional[bytes], amount: int) -> Action: ...
    @staticmethod
    def run_tail(id: Id, tailSpend: Spend, supplyDelta: Delta) -> Action: ...
    @staticmethod
    def mint_nft(clvm: Clvm, metadata: Program, metadataUpdaterPuzzleHash: bytes, royaltyPuzzleHash: bytes, royaltyBasisPoints: int, amount: int, parentId: Optional[Id] = None) -> Action: ...
    @staticmethod
    def update_nft(id: Id, metadataUpdateSpends: List[Spend], transfer: Optional[TransferNftById] = None) -> Action: ...
    @staticmethod
    def fee(amount: int) -> Action: ...
class Deltas:
    def clone(self) -> Deltas: ...
    @staticmethod
    def from_actions(actions: List[Action]) -> Deltas: ...
    def get(self, id: Id) -> Optional[Delta]: ...
    def is_needed(self, id: Id) -> bool: ...
...
class Id:
    ...
    def xch() -> Id: ...
    @staticmethod
    def existing(assetId: bytes) -> Id: ...
    @staticmethod
    def new(index: usize) -> Id: ...
    def is_xch(self) -> bool: ...
    def as_existing(self) -> Optional[bytes]: ...
    def as_new(self) -> Optional[usize]: ...
    def equals(self, id: Id) -> bool: ...
class SendDestination:
    def clone(self) -> SendDestination: ...
    @staticmethod
    def puzzle_hash(puzzleHash: bytes) -> SendDestination: ...
    @staticmethod
    def silent_payment(address: SilentPaymentAddress) -> SendDestination: ...
    def is_puzzle_hash(self) -> bool: ...
    def as_puzzle_hash(self) -> Optional[bytes]: ...
    def is_silent_payment(self) -> bool: ...
    def as_silent_payment(self) -> Optional[SilentPaymentAddress]: ...
class Relation:
...
class Outputs:
    ...
    def xch(self) -> List[Coin]: ...
    def cats(self) -> List[Id]: ...
    def cat(self, id: Id) -> List[Cat]: ...
    def nfts(self) -> List[Id]: ...
    def nft(self, id: Id) -> Nft: ...
class TransferNftById:
    def clone(self) -> TransferNftById: ...
    def __init__(self, ownerId: Optional[Id], tradePrices: List[TradePrice]) -> None: ...
...
class VaultTransaction:
    ...
    def __init__(self, newCustodyHash: Optional[bytes], payments: List[ParsedPayment], nfts: List[ParsedNftTransfer], dropCoins: List[DropCoin], feePaid: int, totalFee: int, reservedFee: int, p2PuzzleHash: bytes, delegatedPuzzleHash: bytes) -> None: ...
...
class Clvm:
    ...
    def create_bulletin(self, parentCoinId: bytes, hiddenPuzzleHash: bytes, messages: List[BulletinMessage]) -> CreatedBulletin: ...
    ...
    def parse_vault_transaction(self, vault: VaultSpendReveal, coinSpends: List[CoinSpend]) -> VaultTransaction: ...
...
class MipsSpend:
    ...
    def bls_member(self, config: MemberConfig, publicKey: PublicKey, fastForward: bool) -> None: ...
    ...
    def singleton_member(self, config: MemberConfig, launcherId: bytes, fastForward: bool, singletonInnerPuzzleHash: bytes, singletonAmount: int) -> None: ...
...
class InnerPuzzleMemo:
    ...
    kind: MemoKind
    def inner_puzzle_hash(self, topLevel: bool) -> bytes: ...
...
class MemberMemo:
    ...
    @staticmethod
    def bls(clvm: Clvm, publicKey: PublicKey, fastForward: bool, taproot: bool, reveal: bool) -> MemberMemo: ...
    @staticmethod
    def passkey(clvm: Clvm, publicKey: R1PublicKey, fastForward: bool, reveal: bool) -> MemberMemo: ...
    @staticmethod
    def singleton(clvm: Clvm, launcherId: bytes, fastForward: bool, reveal: bool) -> MemberMemo: ...
    @staticmethod
...
class MofNMemo:
    ...
    def inner_puzzle_hash(self) -> bytes: ...
class MipsMemoContext:
    def clone(self) -> MipsMemoContext: ...
    def __init__(self) -> None: ...
    def add_k1(self, publicKey: K1PublicKey) -> None: ...
    def add_r1(self, publicKey: R1PublicKey) -> None: ...
    def add_bls(self, publicKey: PublicKey) -> None: ...
    def add_hash(self, hash: bytes) -> None: ...
    def add_timelock(self, timelock: int) -> None: ...
    def add_opcode(self, opcode: int) -> None: ...
    def add_singleton_mode(self, mode: int) -> None: ...
class Mnemonic:
...
class Program:
    ...
    def to_arg_list(self) -> Optional[List[Program]]: ...
...
class Puzzle:
    ...
    def parse_bulletin(self, coin: Coin, solution: Program) -> Optional[Bulletin]: ...
    def parse_child_p2_parent(self, parentCoin: Coin, parentSolution: Program) -> Optional[P2ParentCoinChildParseResult]: ...
...
class MetadataUpdate:
    def clone(self) -> MetadataUpdate: ...
    def __init__(self, kind: UriKind, uri: str) -> None: ...
    kind: UriKind
    uri: str
...
class Bulletin:
    def clone(self) -> Bulletin: ...
    def __init__(self, coin: Coin, hiddenPuzzleHash: bytes, messages: List[BulletinMessage]) -> None: ...
    coin: Coin
    hidden_puzzle_hash: bytes
    messages: List[BulletinMessage]
    def conditions(self, clvm: Clvm) -> List[Program]: ...
    def spend(self, spend: Spend) -> None: ...
class BulletinMessage:
    def clone(self) -> BulletinMessage: ...
    def __init__(self, topic: str, content: str) -> None: ...
    topic: str
    content: str
class CreatedBulletin:
    def clone(self) -> CreatedBulletin: ...
    def __init__(self, bulletin: Bulletin, parentConditions: List[Program]) -> None: ...
    bulletin: Bulletin
    parent_conditions: List[Program]
class P2ParentCoin:
    def clone(self) -> P2ParentCoin: ...
    def __init__(self, coin: Coin, assetId: Optional[bytes], proof: LineageProof) -> None: ...
    coin: Coin
    asset_id: Optional[bytes]
    proof: LineageProof
    @staticmethod
    def inner_puzzle_hash(assetId: Optional[bytes] = None) -> bytes: ...
    @staticmethod
    def puzzle_hash(assetId: Optional[bytes] = None) -> bytes: ...
    def spend(self, delegatedSpend: Spend) -> None: ...
class P2ParentCoinChildParseResult:
    def clone(self) -> P2ParentCoinChildParseResult: ...
    def __init__(self, p2ParentCoin: P2ParentCoin, memos: List[bytes]) -> None: ...
    p2_parent_coin: P2ParentCoin
    memos: List[bytes]
...
class RpcClient:
    ...
    def __init__(self, coinsetUrl: str) -> None: ...
    @staticmethod
    def testnet11() -> RpcClient: ...
    @staticmethod
    def mainnet() -> RpcClient: ...
    @staticmethod
    def local(certBytes: bytes, keyBytes: bytes) -> RpcClient: ...
    @staticmethod
    def local_with_url(baseUrl: str, certBytes: bytes, keyBytes: bytes) -> RpcClient: ...
    ...
    async def get_coin_records_by_hint(self, hint: bytes, startHeight: Optional[int] = None, endHeight: Optional[int] = None, includeSpentCoins: Optional[bool] = None, cursor: Optional[str] = None) -> Awaitable[GetCoinRecordsResponse]: ...
    async def get_coin_records_by_hints(self, hints: List[bytes], startHeight: Optional[int] = None, endHeight: Optional[int] = None, includeSpentCoins: Optional[bool] = None, cursor: Optional[str] = None) -> Awaitable[GetCoinRecordsResponse]: ...
    async def get_coin_records_by_names(self, names: List[bytes], startHeight: Optional[int] = None, endHeight: Optional[int] = None, includeSpentCoins: Optional[bool] = None, cursor: Optional[str] = None) -> Awaitable[GetCoinRecordsResponse]: ...
    async def get_coin_records_by_parent_ids(self, parentIds: List[bytes], startHeight: Optional[int] = None, endHeight: Optional[int] = None, includeSpentCoins: Optional[bool] = None, cursor: Optional[str] = None) -> Awaitable[GetCoinRecordsResponse]: ...
    async def get_coin_records_by_puzzle_hash(self, puzzleHash: bytes, startHeight: Optional[int] = None, endHeight: Optional[int] = None, includeSpentCoins: Optional[bool] = None, cursor: Optional[str] = None) -> Awaitable[GetCoinRecordsResponse]: ...
    async def get_coin_records_by_puzzle_hashes(self, puzzleHashes: List[bytes], startHeight: Optional[int] = None, endHeight: Optional[int] = None, includeSpentCoins: Optional[bool] = None, cursor: Optional[str] = None) -> Awaitable[GetCoinRecordsResponse]: ...
...
class GetCoinRecordsResponse:
    ...
    def __init__(self, coinRecords: Optional[List[CoinRecord]], error: Optional[str], success: bool, truncated: Optional[bool] = None, nextCursor: Optional[str] = None) -> None: ...
...
class R1Signature:
    ...
    def to_bytes(self) -> bytes: ...
class SilentPaymentNetwork(IntEnum):
    Mainnet = 0
    Testnet = 1
class SilentPaymentAddress:
    def clone(self) -> SilentPaymentAddress: ...
    def __init__(self, scanPk: PublicKey, spendPk: PublicKey, network: SilentPaymentNetwork) -> None: ...
    scan_pk: PublicKey
    spend_pk: PublicKey
    network: SilentPaymentNetwork
    def encode(self) -> str: ...
    @staticmethod
    def decode(address: str) -> SilentPaymentAddress: ...
class SilentPaymentKeys:
    def clone(self) -> SilentPaymentKeys: ...
    @staticmethod
    def from_mnemonic(mnemonic: Mnemonic) -> SilentPaymentKeys: ...
    @staticmethod
    def from_secret_keys(scanSk: SecretKey, spendSk: SecretKey) -> SilentPaymentKeys: ...
    def scan_sk(self) -> SecretKey: ...
    def spend_sk(self) -> SecretKey: ...
    def scan_pk(self) -> PublicKey: ...
    def spend_pk(self) -> PublicKey: ...
    def unlabeled_address(self, network: SilentPaymentNetwork) -> SilentPaymentAddress: ...
    def labeled_address(self, network: SilentPaymentNetwork, m: int) -> SilentPaymentAddress: ...
class LabelRegistry:
    def clone(self) -> LabelRegistry: ...
    def __init__(self) -> None: ...
    def register(self, scanSk: SecretKey, m: int) -> None: ...
    def forward(self, m: int) -> Optional[PublicKey]: ...
    def lookup(self, labelPk: PublicKey) -> Optional[int]: ...
    def len(self) -> int: ...
    def is_empty(self) -> bool: ...
class OutputMeta:
    def clone(self) -> OutputMeta: ...
    def __init__(self, puzzleHash: bytes, coinId: bytes, amount: int, parentCoinId: bytes) -> None: ...
    puzzle_hash: bytes
    coin_id: bytes
    amount: int
    parent_coin_id: bytes
class TweakData:
    def clone(self) -> TweakData: ...
    def __init__(self, tweakPoints: List[PublicKey], outputs: List[OutputMeta]) -> None: ...
    tweak_points: List[PublicKey]
    outputs: List[OutputMeta]
class DetectedSpCoin:
    def clone(self) -> DetectedSpCoin: ...
    def __init__(self, coinId: bytes, puzzleHash: bytes, amount: int, parentCoinId: bytes, onetimeSk: SecretKey, k: int, label: Optional[int] = None) -> None: ...
    coin_id: bytes
    puzzle_hash: bytes
    amount: int
    parent_coin_id: bytes
...
class ScalarField:
    ...
    @staticmethod
    def from_bytes(bytes: bytes) -> ScalarField: ...
    def to_bytes(self) -> bytes: ...
class SilentPaymentRegisteredKey:
    def clone(self) -> SilentPaymentRegisteredKey: ...
    def __init__(self, p2PuzzleHash: bytes, publicKey: PublicKey) -> None: ...
    p2_puzzle_hash: bytes
    public_key: PublicKey
class SilentPaymentRegisteredSecretKey:
    def clone(self) -> SilentPaymentRegisteredSecretKey: ...
    def __init__(self, p2PuzzleHash: bytes, secretKey: SecretKey) -> None: ...
    p2_puzzle_hash: bytes
    secret_key: SecretKey
class SilentPayments:
    def clone(self) -> SilentPayments: ...
    @staticmethod
    def scan_from_tweaks(scanSk: SecretKey, spendSk: SecretKey, spendPk: PublicKey, data: TweakData, labels: LabelRegistry, kMax: int) -> List[DetectedSpCoin]: ...
    @staticmethod
    def derive_one_time_puzzle_hash(scanPk: PublicKey, spendPk: PublicKey, aggregatedSenderSk: ScalarField, inputHash: ScalarField, k: int) -> bytes: ...
    @staticmethod
    def compute_input_hash(coinIds: List[bytes], aggregatedSenderPk: PublicKey) -> ScalarField: ...
    @staticmethod
    def aggregate_sender_sks(sks: List[SecretKey]) -> ScalarField: ...
    @staticmethod
    def tweak_data_from_block_spends(coinSpends: List[CoinSpend], additions: List[Coin]) -> TweakData: ...
class Simulator:
    def clone(self) -> Simulator: ...
    def __init__(self) -> None: ...
    @staticmethod
    def with_seed(seed: int) -> Simulator: ...
    def height(self) -> int: ...
    def next_timestamp(self) -> int: ...
    def header_hash(self) -> bytes: ...
    def header_hash_of(self, height: int) -> Optional[bytes]: ...
    ...
    def set_next_timestamp(self, time: int) -> None: ...
    def pass_time(self, time: int) -> None: ...
    def hint_coin(self, coinId: bytes, hint: bytes) -> None: ...
    def coin_state(self, coinId: bytes) -> Optional[CoinState]: ...
    def children(self, coinId: bytes) -> List[CoinState]: ...
    def hinted_coins(self, hint: bytes) -> List[bytes]: ...
    def coin_spend(self, coinId: bytes) -> Optional[CoinSpend]: ...
    def spend_coins(self, coinSpends: List[CoinSpend], secretKeys: List[SecretKey]) -> None: ...
    def new_transaction(self, spendBundle: SpendBundle) -> None: ...
    def lookup_coin_ids(self, coinIds: List[bytes]) -> List[CoinState]: ...
    def lookup_puzzle_hashes(self, puzzleHashes: List[bytes], includeHints: bool) -> List[CoinState]: ...
    def unspent_coins(self, puzzleHash: bytes, includeHints: bool) -> List[Coin]: ...
    def create_block(self) -> None: ...
    def tweak_data_from_block(self, height: int) -> TweakData: ...
    def block_spends(self, height: int) -> List[CoinSpend]: ...
    def block_outputs(self, height: int) -> List[Coin]: ...
class BlsPair:
