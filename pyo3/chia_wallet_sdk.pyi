...
class Action:
    ...
    @staticmethod
    def send(id: Id, puzzleHash: bytes, amount: int, memos: Optional[Program] = None) -> Action: ...
    @staticmethod
    def silent_payment_send(recipient: SilentPaymentAddress, amount: int, memos: Optional[Program] = None) -> Action: ...
    @staticmethod
