...
//
// BRIDGE-06 napi multi-input SP send + scan-from-tweaks E2E.
//
// Closes the napi half of BRIDGE-06 with full FFI fidelity over the multi-input
// flow: TweakData is constructed by SilentPayments.tweakDataFromBlockSpends
// (the BRIDGE-05 helper) over sim.blockSpends(h) + sim.blockOutputs(h) (the
...
// deterministic across the BIND-03 single-input test and this multi-input test.
const TV1_MNEMONIC =
