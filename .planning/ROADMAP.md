...
- [x] 09.3-03-PLAN.md — Reframe ACTION-API-01 + SEND-04 in REQUIREMENTS.md; full CI lint matrix (chip-0057 on/off); Sage zero-edit recompile harness (AC3 checkpoint) (Wave 3)
