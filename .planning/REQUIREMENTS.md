...
- [ ] **WS-01** — A new `chip-0057` workspace feature in the root `Cargo.toml` cascades to `chia-sdk-types/chip-0057`, `chia-sdk-driver/chip-0057`, `chia-sdk-utils/chip-0057`. Bindings feature-default `chip-0057` so bindings ship enabled. Mirrors the `chip-0037` template (commit `bbc7f57f`).
